        		...
        		<div>
        			<span id="left">
        				...
        				<table>
	        				...
	        				<tr>
	        					<td>Phone</td>
	        					<td><input id="phone" type="text" name="phone" value="<?php echo htmlspecialchars($phone);?>" onkeyup="validatePh(this.value)" onblur="validPh(this.value)"/><span class="error">* <?php echo $phoneErr;?></span></td>
	        				</tr>
	        				<tr>
	        					<td>Sex</td>
